    ...
    <section class="news-inner">
        <div class="container-fluid">
            <div class="content">
                <div class="content__block">
                    <div class="pages-head d-block">
                        <span data-aos="fade-down" data-aos-delay="250" data-aos-duration="700">
                             <?php $dt=explode('.',$page->date); ?>
                        ...
                        <ul data-aos="fade-down" data-aos-delay="350" data-aos-duration="700">
                            <?php foreach ($page->services as $it): ?>
            ...
            <div class="other-block">
                <h4 class="other-block__title" data-aos="fade-down" data-aos-delay="250" data-aos-duration="700"><?= \ProcessWire\_x('Other news','-'); ?></h4>
                <div class="row g-0">
                        ...
                        <a href="#" class="news__item">
                            ...
                            <div class="news__text">
                                ...
                                <ul class="news__category">
                                    <?php foreach ($it->services as $item): ?>
                                        <li><?= $item->title; ?></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                ...
                <a href="<?= $page->parent->url; ?>" class="btn btn-full"><?= \ProcessWire\_x('View all news','-'); ?></a>
            </div>
        </div>
    </section>
