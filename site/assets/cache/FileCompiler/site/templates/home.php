...
<div id="all_parts">
                ...
                <div class="row g-0">
                    <div class="col-md-6">
                        ...
                        <a href="javascript:void(0);" class="banner__scroll" data-aos="fade-up" data-aos-delay="1200" data-aos-duration="700">
                            ...
                            <?= \ProcessWire\_x('Scroll for the best experience','-'); ?>
                        </a>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="banner__bottom-text" data-aos="fade-up" data-aos-delay="1200" data-aos-duration="700">
                            <p><?= \ProcessWire\_x('Mainly engaged in the supply of materials used in construction, marinem, oil & gas industry','-'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="services">
        ...
        <div class="row g-0">
            <div class="col-md-6 services__left">
                <h3 class="section-title" data-aos="fade-up" data-aos-delay="150" data-aos-duration="700"><?= \ProcessWire\_x('Wide range of services','-'); ?></h3>
        ...
        <div class="row g-0">
            <div class="col-md-6">
                <h4 class="section-title" data-aos="fade-up" data-aos-delay="150" data-aos-duration="700">
                    <?= \ProcessWire\_x('The numbers speak for our experience','-'); ?>
                </h4>
            </div>
            <div class="col-md-6">
    ...
    <section class="projects">
        <div class="container-fluid pe-md-0">
            <h4 class="section-title" data-aos="fade-up" data-aos-delay="150" data-aos-duration="700">
                <?= \ProcessWire\_x('Successfully completed projects','-'); ?>
            </h4>
        ...
        <a href="<?= $projects->url; ?>" class="btn btn-full mt-4"><?= \ProcessWire\_x('View all projects','-'); ?></a>
    </section>
    <!-- End Projects section -->


    <?php require(\ProcessWire\wire('files')->compile('inc/map.inc',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true))); ?>
    ...
    <section class="partners">
        ...
        <div class="container-fluid pe-lg-0">
            <h4 class="section-title" data-aos="fade-up" data-aos-delay="250" data-aos-duration="700"><?= \ProcessWire\_x('We operate globally','-'); ?></h4>
            <ul class="section-menu">
                <?php
                $partners_image=[];
                ?>
            ...
            <div class="tab-item">
                ...
                <a href="javascript:void(0);" class="btn partners__btn">
                    <span><?= \ProcessWire\_x('view other 65','-'); ?></span>
                </a>
            </div>
            <?php endforeach; ?>
        </div>
    ...
    <section class="contact-section">
        ...
        <div class="container-fluid">
            <div class="contact-section__text">
                <h2 data-aos="fade-up" data-aos-delay="250" data-aos-duration="700"><?= \ProcessWire\_x('Contact with us','-'); ?></h2>
