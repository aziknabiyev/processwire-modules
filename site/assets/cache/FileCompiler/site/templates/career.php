    ...
    <section class="h-r">
                    ...
                    <div class="h-r__desc">
                        <div class="h-r__text">
                            ...
                            <div data-aos="fade-left" class="all_link scroll_to" data-anchor="vcancies_list" data-aos-delay="250" data-aos-duration="700">
                                <a href="javascript:void(0);"><?= \ProcessWire\_x('All vacancies','-'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="h-r__vacancies" data-appoint="vcancies_list">
            <div class="container-fluid">
                <h4 class="section-title"><?= \ProcessWire\_x('Vacancies for you','-'); ?></h4>
                <div class="row g-0">
...
<!--                    <a href="#" class="btn d-md-none w-100 text-center">Load more</a>-->
       ...
       <?php require(\ProcessWire\wire('files')->compile('inc/apply.inc',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true))); ?>
    </section>
