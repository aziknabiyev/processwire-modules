...
<div id="all_parts">
    <section class="services-page">
        <div class="container-fluid pe-lg-0">
            ...
            <div class="projects">
                <h4 class="section-title"><?= _x('Successfully completed projects','-'); ?></h4>
        ...
        <a href="<?= $projects->url; ?>" class="btn btn-full mt-5"><?= _x('View all projects','-'); ?></a>
        ...
        <div class="contact-section">
            ...
            <div class="container-fluid">
                <div class="contact-section__text">
                    <span data-aos="fade-up" data-aos-delay="250" data-aos-duration="700"><?= _x('Next service','-'); ?></span>
